...
INSERT INTO `financial_story` VALUES (1,'We made it work in our 4-generation home.','2018-01-01',1,4,4),(2,'It was a great year. Please check out my pyramid scheme.','2018-03-04',0,8,8),(3,'It was a great year.','2018-03-05',1,8,1),(4,'We had a job loss and a foreclosure on our home.','2019-02-03',1,1,1);
...
--
-- Dumping data for table `story_removals`
--

LOCK TABLES `story_removals` WRITE;
/*!40000 ALTER TABLE `story_removals` DISABLE KEYS */;
/*!40000 ALTER TABLE `story_removals` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-03-02 13:42:51
